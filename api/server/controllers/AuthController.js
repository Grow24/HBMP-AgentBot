...
// const openIdClient = require('openid-client'); // Disabled for Gemini-only setup
...
const refreshController = async (req, res) => {
  ...
  // OpenID functionality disabled for Gemini-only setup
  if (token_provider === 'openid') {
    return res.status(403).send('OpenID authentication disabled');
  }
  try {
